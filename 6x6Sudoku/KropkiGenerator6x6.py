...
File Name: KropkiGenerator6x6.py

Date Started: 5/28/25

Description:
These functions allow me to produce a Kropki Arrangement for all 6x6 Sudoku boards and answer several counting questions, including 
how many 6x6 solutions have a unique Kropki Arrangement, what is the highest and lowest number of circles in a Kropkri Arrangement,
